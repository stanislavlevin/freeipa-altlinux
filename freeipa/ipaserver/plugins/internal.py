...
class i18n_messages(Command):
    ...
    messages = {
        ...
        "ssbrowser-page-content": _(
            "<h1>Browser Kerberos Setup</h1>\n"
            "\n"
            "<h2>Firefox</h2>\n"
            "\n"
            "<p>\n"
            "            You can configure Firefox to use Kerberos for Single "
            "Sign-on. The following instructions will guide you in configuring"
            " your web browser to send your Kerberos credentials to the "
            "appropriate Key Distribution Center which enables Single Sign-on."
            "\n"
            "</p>\n"
            "\n"
            "<ol>\n"
            ...
            "about:config</code> to display the list of current configuration "
            "options.\n"
            "</li>\n"
            "<li>\n"
            "                In the Filter field, type <code>negotiate</code> "
            ...
            "</li>\n"
            "<li>\n"
            "                Enter the name of the domain against which you "
            "want to authenticate, for example, <code class=\"example-domain"
            "\">.example.com.</code>\n"
            "</li>\n"
            "<li><a href=\"../ui/index.html\" id=\"return-link\" class=\"btn "
            "btn-default\">Return to Web UI</a></li>\n"
            "</ol>\n"
            "\n"
            "<h2>Chrome</h2>\n"
            "\n"
            "<p>\n"
            "            You can configure Chrome to use Kerberos for Single "
            "Sign-on. The following instructions will guide you in configuring"
            " your web browser to send your Kerberos credentials to the "
            "appropriate Key Distribution Center which enables Single Sign-on."
            "\n"
            ...
            "<ol>\n"
            "<li>\n"
            "                Download the <a href=\"ca.crt\">CA certificate"
            "</a>. Alternatively, if the host is also an IdM client, you can "
            "find the certificate in /etc/ipa/ca.crt.\n"
            "</li>\n"
            "<li>\n"
            "                Click the menu button with the <em>Customize and "
            "control Google Chrome</em> tooltip, which is by default in the "
            "top right-hand corner of Chrome, and click <em>Settings</em>.\n"
            "</li>\n"
            "<li>\n"
            "                Click <em>Show advanced settings</em> to display "
            "more options, and then click the <em>Manage certificates</em> "
            "button located under the HTTPS/SSL heading.\n"
            "</li>\n"
            "<li>\n"
            "                In the <em>Authorities</em> tab, click the <em>"
            "Import</em> button at the bottom.\n"
            "</li>\n"
            ...
            "managed/mydomain.json</code> file with write privileges limited "
            "to the system administrator or root, and include the following "
            "line:\n"
            "<div><code>\n"
            "                    { \"AuthServerWhitelist\": \"*<span class="
            "\"example-domain\">.example.com.</span>\" }\n"
            "</code></div>\n"
            "<div>\n"
