...
class AssertionRewritingHook(importlib.abc.MetaPathFinder, importlib.abc.Loader):
    ...
    fnpats: Any = ...
    session: Any = ...
    _rewritten_names: Any = ...
    _must_rewrite: Any = ...
    _writing_pyc: bool = ...
    _basenames_to_check_rewrite: Any = ...
    _marked_for_rewrite_cache: Any = ...
    _session_paths_checked: bool = ...
...
def _read_pyc(source: Path, pyc: Path, trace: Callable[[str], None]=...) -> Optional[types.CodeType]: ...
