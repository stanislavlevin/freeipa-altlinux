...
from _pytest.compat import NOTSET as NOTSET, _PytestWrapper as _PytestWrapper, _format_args as _format_args, assert_never as assert_never, final as final, get_real_func as get_real_func, get_real_method as get_real_method, getfuncargnames as getfuncargnames, getimfunc as getimfunc, getlocation as getlocation, is_generator as is_generator, safe_getattr as safe_getattr
from _pytest.config import Config as Config, _PluggyPlugin as _PluggyPlugin
...
from typing import Any, Callable, Deque, Dict, Generator, Iterable, Iterator, List, NoReturn, Optional, Sequence, Tuple, Type, TypeVar, Union, overload
...
class FixtureRequest:
    ...
    def _addfinalizer(self, finalizer: Callable[[], object], scope: Any) -> None: ...
...
def _teardown_yield_fixture(fixturefunc: Any, it: Any) -> None: ...
