...
from _pytest._code.code import ExceptionInfo as ExceptionInfo, TerminalRepr as TerminalRepr, _TracebackStyle as _TracebackStyle
...
from typing import Any, Callable, Iterable, Iterator, List, Optional, Set, Tuple, Type, TypeVar, Union
...
class Node(metaclass=NodeMeta):
    ...
    def _repr_failure_py(self, excinfo: ExceptionInfo[BaseException], style: Optional[_TracebackStyle]=...) -> TerminalRepr: ...
...
def _check_initialpaths_for_relpath(session: Any, fspath: Any): ...
