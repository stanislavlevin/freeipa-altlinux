...
from typing import Any, Dict, Iterable, Iterator, List, NoReturn, Optional, Tuple, Type, TypeVar, Union
...
class BaseReport:
    ...
    def _get_verbose_word(self, config: Config) -> Any: ...
    def _to_json(self) -> Dict[str, Any]: ...
    @classmethod
    def _from_json(cls: Type[_R], reportdict: Dict[str, object]) -> _R: ...

def _report_unserialization_failure(type_name: str, report_class: Type[BaseReport], reportdict: Any) -> NoReturn: ...
