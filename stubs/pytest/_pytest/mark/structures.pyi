...
from _pytest.fixtures import _Scope as _Scope
...
from typing import Any, Callable, Collection, Iterable, Iterator, List, Mapping, MutableMapping, Optional, Sequence, Set, Tuple, Type, TypeVar, Union
...
class ParameterSet:
    ...
    @staticmethod
    def _parse_parametrize_args(argnames: Union[str, List[str], Tuple[str, ...]], argvalues: Iterable[Union[ParameterSet, Sequence[object], object]], *args: Any, **kwargs: Any) -> Tuple[Union[List[str], Tuple[str, ...]], bool]: ...
    @staticmethod
    ...
    @classmethod
    def _for_parametrize(cls: Any, argnames: Union[str, List[str], Tuple[str, ...]], argvalues: Iterable[Union[ParameterSet, Sequence[object], object]], func: Any, config: Config, nodeid: str) -> Tuple[Union[List[str], Tuple[str, ...]], List[ParameterSet]]: ...
