...
from typing import Any, AnyStr, Generator, Iterator, Optional, TextIO, Tuple, Union
...
class CaptureResult:
    ...
    def _replace(self, *, out: Optional[AnyStr]=..., err: Optional[AnyStr]=...) -> CaptureResult[AnyStr]: ...
...
class CaptureManager:
    _method: Any = ...
    _global_capturing: Any = ...
    _capture_fixture: Any = ...
