...
class ALTLinuxPathNamespace(BasePathNamespace):
    ...
    GPG2 = "/usr/bin/gpg2"
    GSSAPI_SESSION_KEY = "/etc/httpd2/ipasession.key"
    ...
    SSHD_IPA_CONFIG = "/etc/openssh/sshd_config.d/04-ipa.conf"
    ...
    OPENSSL_CERTS_DIR = "/var/lib/ssl/certs"
    OPENSSL_PRIVATE_DIR = "/var/lib/ssl/private"
